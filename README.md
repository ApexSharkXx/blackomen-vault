...
### `trading/`
Playbook development, setup definitions, backtesting, reviews, and research.
...
3. **No live trading credentials.** Broker/API secrets belong in environment variables or a secret manager.
